...
@section('main-content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-10"><h5>续费订单管理</h5></div>
                <div class="col-sm-2">
                    <a href="{{ route('sys.order.renew', array_merge($filters, ['export'=>1])) }}" class="btn btn-success pull-right">导出Excel</a>
                </div>
            </div>
        </div>
        ...
        @endif
        <div class="panel-body">
        <form action="{{ route('sys.order.renew') }}" method="get" class="form-horizontal" id="search-form" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <a href="{{ route('sys.order.renew') }}" class="btn btn-sm btn-default">取消搜索</a>
                </div>
            </div>
        </form>
        </div>
